...
namespace SubC.AllegroDotNet
{
    ...
    public static partial class Al
    {
        ...
        /// </para>
        /// <para>
        /// This function may be called prior to <see cref="InstallSystem(int)"/> or <see cref="Init"/>.
        /// </para>
        /// </summary>
        /// <returns>
        ...
        /// while this callback is active. Pass <c>null</c> to revert to the default logging.
