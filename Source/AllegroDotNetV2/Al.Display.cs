...
public static partial class Al
{
  ...
  {
    var pointer = Interop.Context.Core.AlCreateDisplay(width, height);
  ...
  {
    Interop.Context.Core.AlDestroyDisplay(NativePointer.Get(display));
  }
  ...
  {
    return (DisplayFlags)Interop.Context.Core.AlGetNewDisplayFlags();
  }
  ...
  {
    Interop.Context.Core.AlSetNewDisplayFlags((int)flags);
  }
  ...
  public static int GetNewDisplayOption(DisplayOption option, out DisplayImportance importance)
  {
    ...
    var value = Interop.Context.Core.AlGetNewDisplayOption((int)option, ref nativeImportance);
  ...
  {
    Interop.Context.Core.AlSetNewDisplayOption((int)option, value, (int)importance);
  }
  ...
  {
    Interop.Context.Core.AlResetNewDisplayOptions();
  }
  ...
  {
    x = y = 0;
    Interop.Context.Core.AlGetNewWindowPosition(ref x, ref y);
  }
  ...
  {
    Interop.Context.Core.AlSetNewWindowPosition(x, y);
  }
  ...
  {
    return Interop.Context.Core.AlGetNewDisplayRefreshRate();
  }
  ...
  {
    Interop.Context.Core.AlSetNewDisplayRefreshRate(refreshRate);
  }
  ...
  {
    var pointer = Interop.Context.Core.AlGetDisplayEventSource(NativePointer.Get(display));
  ...
  {
    var pointer = Interop.Context.Core.AlGetBackbuffer(NativePointer.Get(display));
  ...
  {
    Interop.Context.Core.AlFlipDisplay();
  }
  ...
  {
    Interop.Context.Core.AlUpdateDisplayRegion(x, y, width, height);
  }
  ...
  {
    return Interop.Context.Core.AlWaitForVsync() == 1;
  }
  ...
  {
    return Interop.Context.Core.AlGetDisplayWidth(NativePointer.Get(display));
  }
  ...
  {
    return Interop.Context.Core.AlGetDisplayHeight(NativePointer.Get(display));
  }
  ...
  {
    return Interop.Context.Core.AlResizeDisplay(NativePointer.Get(display), width, height) == 1;
  }
  ...
  {
    return Interop.Context.Core.AlAcknowledgeResize(NativePointer.Get(display)) == 1;
  }
  ...
  {
    x = y = 0;
    Interop.Context.Core.AlGetWindowPosition(NativePointer.Get(display), ref x, ref y);
  }
  ...
  {
    Interop.Context.Core.AlSetWindowPosition(NativePointer.Get(display), x, y);
  }
    ...
    out int maxHeight)
  {
    ...
    return Interop.Context.Core.AlGetWindowConstraints(
  ...
  {
    return Interop.Context.Core.AlSetWindowConstraints(
      NativePointer.Get(display),
      minWidth,
      minHeight,
      maxWidth,
  ...
  {
    Interop.Context.Core.AlApplyWindowConstraints(NativePointer.Get(display), (byte)(onOff ? 1 : 0));
  }
  ...
  {
    return (DisplayFlags)Interop.Context.Core.AlGetDisplayFlags(NativePointer.Get(display));
  }
  ...
  {
    return Interop.Context.Core.AlSetDisplayFlag(NativePointer.Get(display), (int)flag, (byte)(onOff ? 1 : 0)) == 1;
  }
  ...
  {
    return Interop.Context.Core.AlGetDisplayOption(NativePointer.Get(display), (int)option);
  }
  ...
  {
    Interop.Context.Core.AlSetDisplayOption(NativePointer.Get(display), (int)option, value);
  }
  ...
  {
    return (PixelFormat)Interop.Context.Core.AlGetDisplayFormat(NativePointer.Get(display));
  }
  ...
  {
    return (DisplayOrientation)Interop.Context.Core.AlGetDisplayOrientation(NativePointer.Get(display));
  }
  ...
  {
    return Interop.Context.Core.AlGetDisplayRefreshRate(NativePointer.Get(display));
  }
  ...
  public static void SetWindowTitle(AllegroDisplay? display, string title)
  {
    ...
    Interop.Context.Core.AlSetWindowTitle(NativePointer.Get(display), nativeTitle);
  ...
  {
    var nativeTitle = Marshal.StringToHGlobalAnsi(title);
    Interop.Context.Core.AlSetNewWindowTitle(nativeTitle);
    Marshal.FreeHGlobal(nativeTitle);
  }
  ...
  {
    var pointer = Interop.Context.Core.AlGetNewWindowTitle();
  ...
  {
    Interop.Context.Core.AlSetDisplayIcon(NativePointer.Get(display), NativePointer.Get(icon));
  }
  ...
  public static void SetDisplayIcons(AllegroDisplay? display, int numIcons, AllegroBitmap?[] icons)
  {
    ...
    Interop.Context.Core.AlSetDisplayIcons(NativePointer.Get(display), numIcons, nativeIcons);
  }
  ...
  {
    Interop.Context.Core.AlAcknowledgeDrawingHalt(NativePointer.Get(display));
  }
  ...
  {
    Interop.Context.Core.AlAcknowledgeDrawingResume(NativePointer.Get(display));
  }
  ...
  {
    return Interop.Context.Core.AlInhibitScreensaver((byte)(onOff ? 1 : 0)) == 1;
  }
  ...
  {
    var pointer = Interop.Context.Core.AlGetClipboardText(NativePointer.Get(display));
    return Marshal.PtrToStringAnsi(pointer);
  }
  ...
  public static bool SetClipboardText(AllegroDisplay? display, string text)
  {
    ...
    var value = Interop.Context.Core.AlSetClipboardText(NativePointer.Get(display), nativeText) == 1;
  ...
  {
    return Interop.Context.Core.AlClipboardHasText(NativePointer.Get(display)) == 1;
  }
}